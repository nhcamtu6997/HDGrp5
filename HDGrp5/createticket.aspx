                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtsubject" ValidationGroup="valGroup1" ErrorMessage="Please select a Subject" ForeColor="Red" Display="Dynamic" Font-Size="Small" />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlSubCategory" ValidationGroup="valGroup1" ErrorMessage="Please select a Category" ForeColor="Red" Display="Dynamic" Font-Size="Small"/>
                        ...
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtMessage" ValidationGroup="valGroup1" ErrorMessage="Please describe your issue" ForeColor="Red" Display="Dynamic" Font-Size="Small"/>
                        </div>
